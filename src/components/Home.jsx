...
import userImg from "../assets/imagepic.png";
import cameraIconImg from "../assets/image.png";
...
function Home() {
  ...
  {/* Profile Image with Violet Border */}
  <div className="w-full h-full rounded-full border-2 border-[#6C25FF] overflow-hidden">
    <img src={userImg} alt="user-image" className="w-full h-full object-cover" />
  </div>

  {/* Camera Icon placed outside */}
  <div className="w-[23px] h-[23px] rounded-full absolute bg-[#6C25FF] p-1.5 bottom-0 right-0 translate-x-1/4 translate-y-1/4">
